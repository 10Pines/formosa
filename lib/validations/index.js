...
type Validation = string => ?string

export function makeValidation(nakedValidation: Validation): Validation {
  let validation: Validation = (input) => nakedValidation(input);
